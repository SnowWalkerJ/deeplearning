...
class Model(tf_learn.models.dnn.DNN):
    def build_net(self):
        ...
        self.target_tensor = tf.placeholder(tf.int32, [None, 2], name='target_tensor')
